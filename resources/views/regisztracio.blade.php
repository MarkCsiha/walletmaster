        ...
        <div class="col-md-9">
            ...
            <div class="card w-75 mx-auto mb-3">
                <form class="card-body" action="/regisztracio" method="post">
                    ...
                    <input type="text" class="form-control @error('felhasznalonev') is-invalid @enderror" name="felhasznalonev" value="{{ old("felhasznalonev") }}">
                    ...
                    <input class="form-control @error('telszam') is-invalid @enderror" type="text" name="telszam" id="telszam" value="{{old('telszam')}}">
                    @error('telszam')
                        <p class="text-danger">{{ $message }}</p>
                    @enderror
