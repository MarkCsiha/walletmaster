        ...
        <div class="card mt-3">
            <div class="card-body">
                <form id="debtForm" method="POST" action="/debt">
                    ...
                    <input type="date" class="form-control @error('date') is-invalid @enderror" name="debtDate"
                        id="debtDate">

                    <button type="submit" class="btn btn-dark mt-3 animationBtn" id="button">Tartozás felvitele</button>
